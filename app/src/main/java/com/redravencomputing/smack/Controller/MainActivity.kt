...
import com.redravencomputing.smack.Adapters.MessageAdapter
import com.redravencomputing.smack.Model.Channel
import com.redravencomputing.smack.Model.Message
import com.redravencomputing.smack.R
import com.redravencomputing.smack.Services.AuthService
import com.redravencomputing.smack.Services.MessageService
...
class MainActivity : AppCompatActivity() {
    ...
    fun sendMsgBtnClicked(view: View) {
        if (App.prefs.isLoggedIn && messageTextField.text.isNotEmpty() && selectedChannel != null) {
            ...
            socket.emit("newMessage", messageTextField.text.toString(), userId, channelId, UserDataService.avatarName,  UserDataService.avatarName, UserDataService.avatarColor)
